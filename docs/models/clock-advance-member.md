...
| `status`                                                                                 | [models.ClockAdvanceMemberStatus](../models/clock-advance-member-status.md)              | :heavy_check_mark:                                                                       | Whether this member is pending, committed, or rolled back after a deterministic failure. |
