...
| -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| `status`                                                                               | [operations.ListSimulationsStatus](../../models/operations/list-simulations-status.md) | :heavy_minus_sign:                                                                     | Optional status filter.                                                                |
| `simulatorId`                                                                          | *string*                                                                               | :heavy_minus_sign:                                                                     | Optional Simulator ID filter.                                                          |
| `simulatorDigest`                                                                      | *string*                                                                               | :heavy_minus_sign:                                                                     | Optional exact pinned OCI manifest digest filter.                                      |
