 ...
 */
export function simulationsListSimulationAdvanceEvents(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.ListSimulationAdvanceEventsRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v1/simulations/{id}/advances/{advance_id}/events")(
    pathParams,
  );
