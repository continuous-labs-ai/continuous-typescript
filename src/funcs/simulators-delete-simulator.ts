 ...
 */
export function simulatorsDeleteSimulator(
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.DeleteSimulatorRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/simulators/{id}")(pathParams);
