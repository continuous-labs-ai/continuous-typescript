...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ListSimulationStepsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/simulations/{id}/steps")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListSimulationStepsResponse$inboundSchema),
