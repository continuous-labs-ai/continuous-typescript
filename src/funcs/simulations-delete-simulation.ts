 ...
 */
export function simulationsDeleteSimulation(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeleteSimulationRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/simulations/{id}")(pathParams);
