 ...
 */
export function simulationsGetSimulationAdvance(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetSimulationAdvanceRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/simulations/{id}/advances/{advance_id}")(
    pathParams,
  );
